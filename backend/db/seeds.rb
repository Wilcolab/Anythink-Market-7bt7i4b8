...
user_verified = User.create! email: "user_verified#{rand_part}@test.com", password: '12345password', username: "userverified#{rand_part}", is_verified: true
...
user_not_verified = User.create! email: "user_not_verified#{rand_part}@test.com", password: '12345password', username: "usernotverified#{rand_part}", is_verified: false
